...
# voc数据集根目录以及版本
voc_root = r"C:\Users\72975\Desktop\20221212"
voc_version = "VOC2012"
...
# 转换后的文件保存目录
save_file_root = r"C:\Users\72975\Desktop\20221212\VOC2012\save"

# label标签对应json文件
label_json_path = r'C:\Users\72975\Desktop\20221212\VOC2012\class_indices.json'
    ...
    for file in tqdm(file_names, desc="translate {} file...".format(train_val)):
        ...
        with open(os.path.join(save_txt_path, file + ".txt"), "w") as f:
            for index, obj in enumerate(data["object"]):
                ...
                class_name = obj["name"]
                #class_index = class_dict[class_name] - 1  # 目标id从0开始y
...
def create_class_names(class_dict: dict):
    ...
    with open(r"E:\Robotic_Grasp\datasets\data10\my_data_label.names", "w") as w:
